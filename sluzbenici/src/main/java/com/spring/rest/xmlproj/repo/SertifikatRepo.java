...
public class SertifikatRepo implements Repo<Sertifikat> {
    ...
    public Sertifikat upis(Sertifikat entitet) throws Exception {
        ...
        try {
            ...
            res = (XMLResource) col.createResource(entitet.getBrojSertifikata()+".xml", XMLResource.RESOURCE_TYPE);
    ...
    public void generisiXML(Sertifikat entitet){
        try {
            ...
            File temp = new File(configPath + File.separator + "data" + File.separator + "xml"+ File.separator + "sertifikati" + File.separator +entitet.getBrojSertifikata()+ ".xml");
            temp.createNewFile();
